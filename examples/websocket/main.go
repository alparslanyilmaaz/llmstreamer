...
import (
	...
	"github.com/olporslon/llmstreamer/openai"
)
...
func main() {
	...
	http.HandleFunc("/ws", func(w http.ResponseWriter, r *http.Request) {
		...
		// Close context if client disconnects
		go func() {
			for {
		...
		// Keep chat history per connection
		...
		for {
			...
			cb := &llmstreamer.StreamCallbacks{
				OnContent: func(content string) {
					// Send partial assistant content to client
